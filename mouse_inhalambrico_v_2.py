...
#===================================MOVIMIENTO DEL MOUSE=====================================================
                if bandera_mov == True and bandera_click_normal == False and bandera_click_arrastre == False and bandera_doble_click == False:
                    xm = np.interp(x_p, (X_Y_INI, X_Y_INI + area_width), (X_INI, X_FIN))
                    ym = np.interp(y_p, (X_Y_INI, X_Y_INI + area_height), (Y_INI, Y_FIN))
...
#======================================DOBLE CLICK===========================================================
        ...
        cv2.rectangle(output, (0, 0), (260, 70), (0, 0, 0), -1)
        
        cv2.putText(output,mensaje, (10, 20), cv2.FONT_HERSHEY_COMPLEX, 0.5, (125, 255, 0), 1)
